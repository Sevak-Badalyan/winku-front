...
export default function Shortcuts() {
    ...
    return (
        <div className='shortContainer'>
            <TitleUnderline title={'Shortcuts'} />
            <ul>
                ...
                <li className="miniShortcuts cursor-pointer">
                    <Link to=' '>
                ...
                <li onClick={handleOpenModal} className="miniShortcuts cursor-pointer">
                    <Link to=''>
